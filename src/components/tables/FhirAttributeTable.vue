                    ...
                    <template v-slot:default-header="prop">
                      <div class="row items-center full-width bg-grey-1 q-pa-xs">
                        ...
                        <div class="text-center col-1">
                          <q-radio v-model="attributeMappings[prop.key]" :val="attributeTypes.ID" @input="onAttributeTypeSelected(prop.key, attributeTypes.ID)"/>
                        </div>
                        <div class="text-center col-2">
                          <q-radio v-model="attributeMappings[prop.key]" :val="attributeTypes.QUASI" @input="onAttributeTypeSelected(prop.key, attributeTypes.QUASI)" />
                        </div>
                        <div class="col-1">
                          <q-radio v-model="attributeMappings[prop.key]" :val="attributeTypes.SENSITIVE" @input="onAttributeTypeSelected(prop.key, attributeTypes.SENSITIVE)" />
                        </div>
                      </div>
                    </template>
...
<script lang="ts">
  ...
  export default class FhirAttributeTable extends Vue {
    ...
    onFHIRResourceChanged (): void {
      ([this.currentFHIRProf, this.selectedStr, this.tickedFHIRAttr, this.fhirElementList] = ['', '', [], []]);
    ...
    onAttributeTypeSelected (prop, val) {
