      ...
      <q-list class="menu-list">
        ...
        <q-item v-if="$route.name==='deidentification'" animation>
          <q-stepper flat vertical :contracted="isCollapsed" v-model="step"
            ...
            <q-step :name="1" title="Metadata Analyzer" icon="fas fa-database" :done="step > 1" />
            <q-step :name="2" title="Configuration Manager" icon="fas fa-sliders-h" :done="step > 2" />
            <q-step :name="3" title="De-identifier" icon="fas fa-user-secret" :done="step > 3" />
            <q-step :name="4" title="Evaluater" icon="fas fa-balance-scale" :done="step > 4" />
          </q-stepper>
        </q-item>
        <q-separator />
